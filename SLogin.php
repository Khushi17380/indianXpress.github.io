...
<form action="authenn_login.php" method="post">
  <div class="imgcontainer">
    <img src="img_avatar2.png" alt="Avatar" class="avatar">
  </div>

  <div class="container">
    <center><label for="user_id"><b>Username</b></label><br>
  ...
  <div class="container" style="background-color:#f1f1f1">
    <button type="button" class="cancelbtn"><a href="FirstPage.php">Cancel</a></button>
